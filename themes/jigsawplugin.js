	...
	jigsaw : function(id, imgUri, limitWidth, breakCount, swapCount, completed){
		...
		var verify = function(){
			...
			if(success){
				...
				alert('Congratuations! You made it!');
			}
		};
		...
		$(mainImage).load(function(e){
			...
			cursor1.css('border-top', 'solid 2px white');
			cursor1.css('border-left', 'solid 2px white');
			cursor1.css('border-right', 'solid 2px red');
			cursor1.css('border-bottom', 'solid 2px red');
